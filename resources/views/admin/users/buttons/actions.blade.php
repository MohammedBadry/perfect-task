...
<div class="dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
		<ul class="link-list-plain">
			<li><a href="{{ aurl('sales/'.$id.'/user')}}" class="text-primary"><em class="icon ni ni-eye-fill"></em>المبيعات</a></li>
			<li><a href="{{ url(request()->segment('1').'/users/'.$id.'/edit')}}" class="text-primary"><em class="icon ni ni-edit-fill"></em> {{trans('admin.edit')}}</a></li>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				{!! Form::open([
				'method' => 'DELETE',
				'route' => [request()->segment('1').'.users.destroy', $id]
				]) !!}
