                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                ...
                                <form method="post" action="{{url(request()->segment('1').'/login')}}" class="form-validate is-alter" dir="rtl">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <a class="link link-primary link-sm" href="{{url(request()->segment(1).'/forgot/password')}}">نسيت كلمة المرور؟</a>
                                        </div>
                                        <div class="form-control-wrap">
                                    ...
                                    <div class="form-note-s2 pt-4"> ليس لديك حساب؟ <a href="{{url('vendor/register')}}">سجل الآن</a></div>
                                    @endif
                            </div>
                        </div>
                    </div>
