...
<head>
    ...
    <script>
        ...
        var vendor_id = "{{ admin()->user()->id }}";
        var is_vendor = "{{admin()->user()->is_vendor}}";
    </script>
</head>
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> {{ date('Y') }} {{ setting()->{l('sitename')} }} - تصميم وتطوير 
                            <a href="https://mnjz.sa">شركة منجز لتقنية المعلومات</a>
                            </div>
                        </div>
                    </div>
                </div>
