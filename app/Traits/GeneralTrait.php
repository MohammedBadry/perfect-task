...
trait GeneralTrait
{
    ...
    public function returnData($data, $message = "", $additional_data = null)
    {
        $res1 = [
            'status' => true,
            'code' => "200",
        ...
        if($additional_data!='' && $additional_data!=null) {
            $final_res = array_merge($res1, $additional_data);
        } else {
            $final_res = $res1;
        }     
    ...
    public function returnWithDataError($data, $message, $code, $additional_data = null)
    {
        $res1 = [
            'status' => false,
            'code' => $code,
